/* session-list.c generated by valac 0.30.1, the Vala compiler
...
static GObject * session_prompt_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	if (_tmp6_) {
		...
		_tmp16_ = lightdm_get_sessions ();
		{
			...
			for (session_it = session_collection; session_it != NULL; session_it = session_it->next) {
				...
				_tmp17_ = _g_object_ref0 ((LightDMSession*) session_it->data);
				session = _tmp17_;
				{
					LightDMSession* _tmp18_ = NULL;
					const gchar* _tmp19_ = NULL;
					const gchar* _tmp20_ = NULL;
					LightDMSession* _tmp21_ = NULL;
					const gchar* _tmp22_ = NULL;
					const gchar* _tmp23_ = NULL;
					ToggleBox* _tmp24_ = NULL;
					LightDMSession* _tmp25_ = NULL;
					const gchar* _tmp26_ = NULL;
					const gchar* _tmp27_ = NULL;
					LightDMSession* _tmp28_ = NULL;
					...
					_tmp18_ = session;
					_tmp19_ = lightdm_session_get_key (_tmp18_);
					_tmp20_ = _tmp19_;
					_tmp21_ = session;
					_tmp22_ = lightdm_session_get_name (_tmp21_);
					_tmp23_ = _tmp22_;
					g_debug ("session-list.vala:49: Adding session %s (%s)", _tmp20_, _tmp23_);
					...
					_tmp33_ = _tmp32_;
					_tmp34_ = session_list_get_badge (_tmp33_);
					_tmp35_ = _tmp34_;
					toggle_box_add_item (_tmp24_, _tmp27_, _tmp30_, _tmp35_);
	...
	g_signal_connect_object ((GObject*) _tmp36_, "notify::selected-key", (GCallback) _session_prompt_selected_cb_g_object_notify, self, 0);
	_tmp37_ = self->priv->box;
	gtk_widget_show ((GtkWidget*) _tmp37_);
	_tmp38_ = self->priv->box;
	prompt_box_attach_item ((PromptBox*) self, (GtkWidget*) _tmp38_, TRUE);
	return obj;
}
...
static gchar* session_list_get_badge_name (const gchar* session) {
	...
	} else if ((((((_tmp3_ == ((0 != _tmp2_label2) ? _tmp2_label2 : (_tmp2_label2 = g_quark_from_static_string ("gnome-classic")))) || (_tmp3_ == ((0 != _tmp2_label3) ? _tmp2_label3 : (_tmp2_label3 = g_quark_from_static_string ("gnome-flashback-compiz"))))) || (_tmp3_ == ((0 != _tmp2_label4) ? _tmp2_label4 : (_tmp2_label4 = g_quark_from_static_string ("gnome-flashback-metacity"))))) || (_tmp3_ == ((0 != _tmp2_label5) ? _tmp2_label5 : (_tmp2_label5 = g_quark_from_static_string ("gnome-shell"))))) || (_tmp3_ == ((0 != _tmp2_label6) ? _tmp2_label6 : (_tmp2_label6 = g_quark_from_static_string ("gnome-wayland"))))) || (_tmp3_ == ((0 != _tmp2_label7) ? _tmp2_label7 : (_tmp2_label7 = g_quark_from_static_string ("gnome"))))) {
		switch (0) {
			default:
			{
				gchar* _tmp5_ = NULL;
	...
	} else if (((_tmp3_ == ((0 != _tmp2_label8) ? _tmp2_label8 : (_tmp2_label8 = g_quark_from_static_string ("kde")))) || (_tmp3_ == ((0 != _tmp2_label9) ? _tmp2_label9 : (_tmp2_label9 = g_quark_from_static_string ("kde-plasma"))))) || (_tmp3_ == ((0 != _tmp2_label10) ? _tmp2_label10 : (_tmp2_label10 = g_quark_from_static_string ("plasma"))))) {
		switch (0) {
			default:
			{
				gchar* _tmp6_ = NULL;
...
GdkPixbuf* session_list_get_badge (const gchar* session) {
	...
	if (_tmp20_ == NULL) {
		...
		__catch19_g_error:
		{
			...
			g_debug ("session-list.vala:152: Error loading badge %s: %s", _tmp33_, _tmp35_);
			_g_error_free0 (e);
		}
		__finally19:
		if (G_UNLIKELY (_inner_error_ != NULL)) {
