/* user-list.c generated by valac 0.30.1, the Vala compiler
...
static gboolean user_list_filter_group (UserList* self, const gchar* user_name);
#define UG_SETTINGS_KEY_GROUP_FILTER "group-filter"
static gboolean user_list_in_group (UserList* self, const gchar* group_name, const gchar* user_name);
...
static gboolean user_list_is_supported_remote_session (UserList* self, const gchar* session_internal_name) {
	...
	_tmp3_ = lightdm_get_remote_sessions ();
	{
		...
		for (session_it = session_collection; session_it != NULL; session_it = session_it->next) {
			...
			_tmp4_ = _g_object_ref0 ((LightDMSession*) session_it->data);
			session = _tmp4_;
			{
				LightDMSession* _tmp5_ = NULL;
				const gchar* _tmp6_ = NULL;
				const gchar* _tmp7_ = NULL;
				const gchar* _tmp8_ = NULL;
				_tmp5_ = session;
...
static void user_list_fill_list (UserList* self) {
	...
	if (_tmp1_) {
		...
		UnityGreeter* _tmp7_ = NULL;
		gboolean _tmp8_ = FALSE;
		UnityGreeter* _tmp19_ = NULL;
		gboolean _tmp20_ = FALSE;
		gboolean _tmp21_ = FALSE;
		gchar* last_user = NULL;
		UnityGreeter* _tmp22_ = NULL;
		gchar* _tmp23_ = NULL;
		UnityGreeter* _tmp24_ = NULL;
		gchar* _tmp25_ = NULL;
		gchar* _tmp26_ = NULL;
		gboolean _tmp27_ = FALSE;
		...
		if (!_tmp8_) {
			...
			_tmp16_ = _tmp15_;
			{
				...
				for (user_it = user_collection; user_it != NULL; user_it = user_it->next) {
					...
					_tmp17_ = _g_object_ref0 ((LightDMUser*) user_it->data);
					user = _tmp17_;
					{
						LightDMUser* _tmp18_ = NULL;
						_tmp18_ = user;
		...
		_tmp20_ = unity_greeter_has_guest_account_hint (_tmp19_);
		if (_tmp20_) {
		...
		_tmp22_ = unity_greeter_singleton;
		_tmp23_ = unity_greeter_get_state (_tmp22_, "last-user");
		last_user = _tmp23_;
		_tmp24_ = unity_greeter_singleton;
		_tmp25_ = unity_greeter_select_user_hint (_tmp24_);
		_tmp26_ = _tmp25_;
		_tmp27_ = _tmp26_ != NULL;
		_g_free0 (_tmp26_);
		if (_tmp27_) {
			UnityGreeter* _tmp28_ = NULL;
			gchar* _tmp29_ = NULL;
			gchar* _tmp30_ = NULL;
			_tmp28_ = unity_greeter_singleton;
			_tmp29_ = unity_greeter_select_user_hint (_tmp28_);
			_tmp30_ = _tmp29_;
			...
			if (_tmp31_ != NULL) {
				const gchar* _tmp32_ = NULL;
				_tmp32_ = last_user;
				greeter_list_set_active_entry ((GreeterList*) self, _tmp32_);
			}
		}
		_g_free0 (last_user);
	}
...
static void user_list_user_added_cb (UserList* self, LightDMUser* user) {
	...
	LightDMUser* _tmp35_ = NULL;
	const gchar* _tmp36_ = NULL;
	const gchar* _tmp37_ = NULL;
	LightDMUser* _tmp38_ = NULL;
	gboolean _tmp39_ = FALSE;
	gboolean _tmp40_ = FALSE;
	LightDMUser* _tmp41_ = NULL;
	gboolean _tmp42_ = FALSE;
	gboolean _tmp43_ = FALSE;
	LightDMUser* _tmp44_ = NULL;
	...
	_tmp16_ = user;
	_tmp17_ = lightdm_user_get_name (_tmp16_);
	_tmp18_ = _tmp17_;
	_tmp19_ = user_list_filter_group (self, _tmp18_);
	if (!_tmp19_) {
		return;
	}
	_tmp20_ = user;
	...
	label = _tmp23_;
	_tmp24_ = user;
	_tmp25_ = lightdm_user_get_real_name (_tmp24_);
	_tmp26_ = _tmp25_;
	...
	_tmp31_ = user;
	_tmp32_ = lightdm_user_get_name (_tmp31_);
	_tmp33_ = _tmp32_;
	_tmp34_ = label;
	_tmp35_ = user;
	_tmp36_ = lightdm_user_get_background (_tmp35_);
	_tmp37_ = _tmp36_;
	_tmp38_ = user;
	_tmp39_ = lightdm_user_get_logged_in (_tmp38_);
	_tmp40_ = _tmp39_;
	_tmp41_ = user;
	_tmp42_ = lightdm_user_get_has_messages (_tmp41_);
	_tmp43_ = _tmp42_;
	_tmp44_ = user;
	_tmp45_ = lightdm_user_get_session (_tmp44_);
	_tmp46_ = _tmp45_;
	user_list_add_user (self, _tmp33_, _tmp34_, _tmp37_, _tmp40_, _tmp43_, _tmp46_);
	_g_free0 (label);
}
...
static gboolean user_list_filter_group (UserList* self, const gchar* user_name) {
	...
	gint _tmp0_ = 0;
	gchar** _tmp1_ = NULL;
	gint group_filter_length1 = 0;
	gint _group_filter_size_ = 0;
	gchar** _tmp2_ = NULL;
	gint _tmp2__length1 = 0;
	gchar** _tmp3_ = NULL;
	gint _tmp3__length1 = 0;
	...
	_tmp3__length1 = group_filter_length1;
	{
		...
		for (group_name_it = 0; group_name_it < _tmp3__length1; group_name_it = group_name_it + 1) {
			gchar* _tmp4_ = NULL;
			...
			group_name = _tmp4_;
			{
				...
				_tmp5_ = group_name;
				_tmp6_ = user_name;
				_tmp7_ = user_list_in_group (self, _tmp5_, _tmp6_);
				if (_tmp7_) {
					result = TRUE;
					_g_free0 (group_name);
					group_filter = (_vala_array_free (group_filter, group_filter_length1, (GDestroyNotify) g_free), NULL);
...
static gboolean user_list_in_group (UserList* self, const gchar* group_name, const gchar* user_name) {
	...
	const gchar* _tmp0_ = NULL;
	struct group* _tmp1_ = NULL;
	struct group* _tmp2_ = NULL;
	struct group* _tmp3_ = NULL;
	gchar** _tmp4_ = NULL;
	...
	_tmp3_ = group;
	_tmp4_ = _tmp3_->gr_mem;
	_tmp4__length1 = _vala_array_length (_tmp3_->gr_mem);
	{
		...
		for (name_it = 0; name_it < _tmp4__length1; name_it = name_it + 1) {
			gchar* _tmp5_ = NULL;
			gchar* name = NULL;
...
static void user_list_user_removed_cb (UserList* self, LightDMUser* user) {
	...
	_tmp1_ = lightdm_user_get_name (_tmp0_);
	_tmp2_ = _tmp1_;
	g_debug ("user-list.vala:1080: Removing user %s", _tmp2_);
	_tmp3_ = user;
...
static void user_list_test_respond (UserList* self, const gchar* text) {
	...
	g_return_if_fail (text != NULL);
	_tmp0_ = text;
	g_debug ("user-list.vala:1478: response %s", _tmp0_);
		...
		switch (0) {
			default:
			{
				...
				if (_tmp5_ == NULL) {
					...
					gchar* _tmp8_ = NULL;
					_tmp6_ = text;
					g_debug ("user-list.vala:1484: username=%s", _tmp6_);
					_tmp7_ = text;
					_tmp8_ = g_strdup (_tmp7_);
...
void user_list_set_show_hidden_users (UserList* self, gboolean value) {
	...
	_tmp14_ = _tmp13_;
	{
		...
		for (user_it = user_collection; user_it != NULL; user_it = user_it->next) {
			LightDMUser* _tmp15_ = NULL;
			LightDMUser* user = NULL;
			_tmp15_ = _g_object_ref0 ((LightDMUser*) user_it->data);
			user = _tmp15_;
			{
				gchar** _tmp16_ = NULL;
				gint _tmp16__length1 = 0;
				_tmp16_ = hidden_users;
				_tmp16__length1 = hidden_users_length1;
				{
					gchar** username_collection = NULL;
					gint username_collection_length1 = 0;
					gint _username_collection_size_ = 0;
					gint username_it = 0;
					username_collection = _tmp16_;
					username_collection_length1 = _tmp16__length1;
					for (username_it = 0; username_it < _tmp16__length1; username_it = username_it + 1) {
						gchar* _tmp17_ = NULL;
						gchar* username = NULL;
						_tmp17_ = g_strdup (username_collection[username_it]);
						username = _tmp17_;
						{
							LightDMUser* _tmp18_ = NULL;
							const gchar* _tmp19_ = NULL;
							...
							if (g_strcmp0 (_tmp20_, _tmp21_) == 0) {
								...
								_tmp22_ = username;
								g_debug ("user-list.vala:98: Showing hidden user %s", _tmp22_);
								_tmp23_ = user;
								user_list_user_added_cb (self, _tmp23_);
							}
							_g_free0 (username);
						}
					}
