/* prompt-box.c generated by valac 0.30.1, the Vala compiler
...
static GtkGrid* prompt_box_real_create_name_grid (PromptBox* self) {
	...
	FlatButton* _tmp38_ = NULL;
	AtkObject* _tmp39_ = NULL;
	const gchar* _tmp40_ = NULL;
	FlatButton* _tmp41_ = NULL;
	CachedImage* _tmp42_ = NULL;
	CachedImage* _tmp43_ = NULL;
	FlatButton* _tmp44_ = NULL;
	CachedImage* _tmp45_ = NULL;
	FlatButton* _tmp46_ = NULL;
	...
	_tmp41_ = self->option_button;
	g_signal_connect_object ((GtkButton*) _tmp41_, "clicked", (GCallback) _prompt_box_option_button_clicked_cb_gtk_button_clicked, self, 0);
	_tmp42_ = cached_image_new (NULL);
	g_object_ref_sink (_tmp42_);
	_g_object_unref0 (self->priv->option_image);
	self->priv->option_image = _tmp42_;
	_tmp43_ = self->priv->option_image;
...
void prompt_box_add_message (PromptBox* self, const gchar* text, gboolean is_error) {
	...
	_tmp9_ = label;
	gtk_label_set_xalign ((GtkLabel*) _tmp9_, 0.0f);
	_tmp10_ = label;
	_tmp11_ = is_error;
...
static GObject * active_indicator_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	__catch18_g_error:
	{
		...
		g_debug ("prompt-box.vala:634: Could not load active image: %s", _tmp5_);
		_g_error_free0 (e);
	}
	__finally18:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
